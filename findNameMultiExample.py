...
#code below from https://stackabuse.com/phonetic-similarity-of-words-a-vectorized-approach-in-python/
#might be worth wile to check the combination of multiple phonetic algorythims
#http://advas.sourceforge.net/ < this is the actual module used
